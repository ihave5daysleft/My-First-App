                    ...
                    if i == st.session_state.mole_pos:
                        ...
                        # 1. TJEK HVAD VI RAMTE
                            if st.session_state.game_item == "🐹":
                                ...
                                st.session_state.pizza_points += points
                                rain(emoji="💎", font_size=54, falling_speed=1.5, animation_length=4)    
...
# ==========================================
    ...
    tool_choice = st.radio("Choose Tool:", ["📝 To-Do List", "🎲 Decision Maker", "⚖️ BMI calculator", "🎱Magic 8-Ball"], horizontal=True)
    st.markdown("---")
